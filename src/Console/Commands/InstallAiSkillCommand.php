...
{
    protected $signature = 'oi-ai:install-ai-skill';

    protected $description = '[Deprecated] Use `oi:skills` instead. Install AI assistant skill files for oi-laravel-ai';

    private const SKILL_NAME = 'oilab-laravel-ai';

    private const SECTION = 'oi-lab/oi-laravel-ai rules';
    ...
    private function addSkillToClaudeMd(): void
    {
        ...
        if (! file_exists($claudeMdPath)) {
            ...
            $this->info('Created CLAUDE.md with oi-laravel-ai rules.');
        ...
        if (! str_contains($content, $sectionHeader)) {
            ...
            $this->info('Added oi-laravel-ai rules section to CLAUDE.md.');
        ...
        $this->info('Updated oi-laravel-ai rules section in CLAUDE.md.');
    }
}
